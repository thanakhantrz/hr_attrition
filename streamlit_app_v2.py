...
# ── Resume Page ───────────────────────────────────────────
    ...
    st.caption("Use this page to copy resume descriptions tailored to the role you're applying for.")
    ...
    with tab1:
        ...
        <div class="resume-box">
            ...
            • Built an interactive dashboard deployed on Streamlit Cloud
              with department and gender filters for HR decision-makers<br>
        ...
        for tag in ["Data Analysis","People Analytics","Attrition Modelling","Dashboard Design","Python","Streamlit","HR Strategy"]:
    ...
    with tab2:
        ...
        <div class="resume-box">
            ...
            • Applied data validation techniques to detect and correct a synthetic data flaw
              where work-life balance showed an inverted attrition relationship —
              rebuilt data generation logic with explicit probability mapping per variable<br>
            • Deployed interactive dashboard on Streamlit Cloud with
              real-time filters across department, gender, and overtime
            </div>
        </div>
        """, unsafe_allow_html=True)
        st.markdown("**Skills demonstrated:**")
        for tag in ["EDA","Data Validation","Pipeline Design","Python","Plotly","Streamlit","Statistical Analysis","Data Cleaning"]:
            st.markdown(f'<span class="tag">{tag}</span>', unsafe_allow_html=True)
    ...
    dataset structure, with 1,470 employee records and 19 variables covering demographics,
    compensation, satisfaction scores, and attrition outcomes.<br><br>
    The analysis covers 9 dimensions of attrition risk and includes a high-risk employee
    identification table, a department × satisfaction heatmap, and an income distribution comparison.
    The project also involved identifying and correcting a data generation flaw where work-life
    balance was not correctly wired into attrition probability — demonstrating data validation
    and critical thinking beyond basic charting.
    </div>
    """, unsafe_allow_html=True)
