...
• Analysed 2 company profiles (3,620+ employee records) to identify key drivers
...
• Designed and executed end-to-end data analysis pipeline across 2 company profiles
  (3,620+ employee records, 19 variables each)
